 ...
 * @property float   $horizontalAccuracy     number    optional. the radius of uncertainty for the location, measured
 *           in meters; 0-1500
 * @property integer $livePeriod             optional. time relative to the message sending date, during which the
 ...
 * @property integer $proximityAlertRadius   optional. maximum distance for proximity alerts about approaching another
