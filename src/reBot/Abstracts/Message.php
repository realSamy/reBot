 ...
 * @property Chat                    $sender_chat               Optional. Sender of the message, sent on behalf of a
 ...
 * @property User                    $forward_from              Optional. For forwarded messages, sender of the original
 *           message
 * @property Chat                    $forward_from_chat          Optional. For messages forwarded from channels or from
 *           anonymous administrators, information about the original sender chat
 * @property int                     $forward_from_message_id     Optional. For messages forwarded from channels,
 *           identifier of the original message in the channel
 * @property string                  $forward_signature         Optional. For messages forwarded from channels,
 *           signature
 *           of the post author if present
 * @property string                  $forward_sender_name        Optional. Sender's name for messages forwarded from
 *           users
 *           who disallow adding a link to their account in forwarded messages
 * @property int                     $forward_date              Optional. For forwarded messages, date the original
 *           message was sent in Unix time
 * @property Message                 $reply_to_message           Optional. For replies, the original message. Note that
 ...
 * @property string                  $media_group_id             Optional. The unique identifier of a media message group
 *           this message belongs to
 * @property string                  $author_signature          Optional. Signature of the post author for messages in
 ...
 *           video
 * @property VideoNote               $video_note                Optional. Message is a video note, information about the
 *           video message
 ...
 *           about
 *           the location
 * @property User[]                  $new_chat_members           Optional. New members that were added to the group or
 *           supergroup and information about them (the bot itself may be one of these members)
 * @property User                    $left_chat_member           Optional. A member was removed from the group,
 ...
 * @property true                    $supergroup_chat_created    Optional. Service message: the supergroup has been
 ...
 * @property true                    $channel_chat_created       Optional. Service message: the channel has been created.
 ...
 * @property int                     $migrate_to_chat_id          Optional. The group has been migrated to a supergroup
 ...
 * @property int                     $migrate_from_chat_id        Optional. The supergroup has been migrated from a group
 *           with the specified identifier. This number may be greater than 32 bits and some programming languages may
 *           have difficulty/silent defects in interpreting it. But it is smaller than 52 bits, so a signed 64 bit
 *           integer or double-precision float type are safe for storing this identifier.
 * @property Message                 $pinned_message            Optional. Specified message was pinned. Note that the
 ...
 * @property SuccessfulPayment       $successful_payment        Optional. Message is a service message about a
 *           successful
 *           payment, information about the payment. More about payments »
 * @property string                  $connected_website         Optional. The domain name of the website on which the
