 ...
 *           pressed
 * @property LoginUrl     $login_url                         optional. an http url used to automatically authorize
 ...
 * @property string       $switch_inline_query                optional. if set, pressing the button will prompt the
 ...
 * @property string       $switch_inline_query_current_chat     optional. if set, pressing the button will insert the
 ...
 * @property CallbackGame $callback_game                     optional. description of the game that will be launched
