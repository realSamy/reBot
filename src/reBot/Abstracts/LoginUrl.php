 ...
 * @property string  $botUsername          optional. username of a bot, which will be used for user authorization. see
 ...
 *           details.
 * @property boolean $requestWriteAccess   optional. pass true to request the permission for your bot to send messages
 *           to the user.
