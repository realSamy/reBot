 ...
 *
 * @property integer $migrateToChatId   optional. the group has been migrated to a supergroup with the specified
 ...
 * @property integer $retryAfter        optional. in case of exceeding flood control, the number of seconds left to
