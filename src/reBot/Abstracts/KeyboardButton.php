 ...
 * @property boolean                $request_contact   optional. if true, the user's phone number will be sent as a
 *           contact when the button is pressed. available in private chats only
 * @property boolean                $request_location  optional. if true, the user's current location will be sent when
