 ...
 * @property ?Message         $pinned_message    Optional. The most recent pinned message (by sending date). Returned
 *           only in getChat.
 * @property ?ChatPermissions $permissions      Optional. Default chat member permissions, for groups and supergroups.
 *           Returned only in getChat.
 * @property ?int             $slow_mode_delay    Optional. For supergroups, the minimum allowed delay between
 ...
 *           getChat.
 * @property ?bool            $can_set_sticker_set Optional. True, if the bot can change the group sticker set. Returned
 *           only in getChat.
 * @property ?int             $linked_chat_id     Optional. Unique identifier for the linked chat, i.e. the discussion
