 ...
 *           “eyes”, “mouth”, or “chin”.
 * @property float  $x_shift shift by x-axis measured in widths of the mask scaled to the face size, from left to right.
 *           for example, choosing -1.0 will place mask just to the left of the default mask position.
 * @property float  $y_shift shift by y-axis measured in heights of the mask scaled to the face size, from top to
